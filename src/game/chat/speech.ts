// Speech bubbles (M2 T2): pure fold over EngineEvents — a bot "says" its
// latest AssistantText for a few seconds. Ported from
// panels/world/lib/speech.ts (same TTL/trim semantics); the subscription
// lives in use-speech-bubbles.ts.

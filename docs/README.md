...
These are the active documents for the browser-world rebuild. All are in English.
...
| [ROADMAP.md](ROADMAP.md) | Milestones, current status, and acceptance criteria |
| [ASTRA_HANDOFF.md](ASTRA_HANDOFF.md) | Self-contained brief for the next visual implementation |
| [ARCHIVE.md](ARCHIVE.md) | Preserved desktop version and recovery procedure |

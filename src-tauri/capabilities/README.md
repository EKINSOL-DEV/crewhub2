...
| workspace.json  | workspace | core:default                       | Workspace window (world-primary shell): panels in their own window — event listen + typed IPC, same discipline as the settings window. Nothing else.                                                           |
